                ...
                {activeRegister === 'Leader' ?
                    <>
                        <div className="flex flex-col items-center w-full md:w-5/6">
                            ...
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="LastName" className="font-chakra text-neoBlue mb-2">Last name</label>
                                <input type="text" placeholder="Last name" className="font-chakra bg-neoBlueLight p-1 px-2 border-0 outline-0 text-white" value={leaderLastName} onChange={leaderLastNameHandler}></input>
                            </div>
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="TeamName" className="font-chakra text-neoBlue mb-2">Team name</label>
                                <input type="text" placeholder="Team name" className="font-chakra bg-neoBlueLight p-1 px-2 border-0 outline-0 text-white" value={teamName} onChange={teamNameHandler}></input>
                            </div>
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="Email" className="font-chakra text-neoBlue mb-2">Email</label>
                                <input type="email" placeholder="Email" className="font-chakra bg-neoBlueLight p-1 px-2 border-0 outline-0 text-white" value={leaderEmail} onChange={leaderEmailHandler}></input>
                            </div>
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="Github" className="font-chakra text-neoBlue mb-2">Github Link</label>
                                <input type="text" placeholder="Enter your Github repository link" className="font-chakra bg-neoBlueLight p-1 px-2 border-0 outline-0 text-white" value={leaderGithub} onChange={leaderGithubHandler}></input>
                            </div>
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="RegNo" className="font-chakra text-neoBlue mb-2">Registration number</label>
                                <input type="text" placeholder="Enter your Registration number" className="font-chakra bg-neoBlueLight p-1 px-2 border-0 outline-0 text-white" value={leaderRegNo} onChange={leaderRegNoHandler}></input>
                            </div>
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="PhoneNo" className="font-chakra text-neoBlue mb-2">Phone number</label>
                    ...
                    : <>
                        <div className="flex flex-col items-center w-full md:w-5/6">
                            ...
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="LastName" className="font-chakra text-neoBlue mb-2">Last name</label>
                                <input type="text" placeholder="Last name" className="font-chakra bg-neoBlueLight p-1 px-2 border-0 outline-0 text-white" value={memberLastName} onChange={memberLastNameHandler}></input>
                            </div>
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="Email" className="font-chakra text-neoBlue mb-2">Email</label>
                            ...
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="PhoneNo" className="font-chakra text-neoBlue mb-2">Phone number</label>
                                <input type="text" placeholder="Phone number" className="font-chakra bg-neoBlueLight p-1 px-2 border-0 outline-0 text-white" value={memberPhoneNo} onChange={MemberPhoneNoHandler}></input>
                            </div>
                            <div className="flex flex-col w-5/6 my-4">
                                <label htmlFor="RefCode" className="font-chakra text-neoBlue mb-2">Referral code</label>
