  ...
  <div className="w-full block flex-grow lg:flex justify-between lg:items-center lg:w-auto">
    <div className="text-md flex w-1/2 justify-around pl-8 pr-6">
        <div className='inline-flex '>
            <Link to="/" className={`${
                activeLink === "home"? "border-neoBlue border-b-2 border-neoBlue-500 text-neoBlue text-neoBlue-900"
        ...
        <div className='inline-flex'>
            <Link to="/tracks" className={`${
                activeLink === "tracks"? "border-neoBlue border-b-2 border-neoBlue-500 text-neoBlue text-neoBlue-900"
                : " text-white text-white-500"
                } inline-flex items-center px-1 pt-1  text-sm font-medium block mt-4 lg:inline-block lg:mt-0 mr-4`} 
        ...
        <div className='inline-flex'>
            <Link to="/prizes" className={`${
                activeLink === "prizes" ? "border-neoBlue border-b-2 border-neoBlue-500 text-neoBlue text-neoBlue-900"
                : " text-white text-white-500"
                } inline-flex items-center px-1 pt-1  text-sm font-medium block mt-4 lg:inline-block lg:mt-0 mr-4`} 
    ...
    <div className="flex-basis-1/2 mr-8">
      <a href="https://google.com" style={{clipPath: 'polygon(0 0, 100% 0, 100% 20%, 97% 30%,97% 70%,100% 80%, 100% 100%, 5% 100%,0% 80%)'}} className="inline-block text-sm px-4 py-2 leading-none border text-darkBlue bg-neoBlue mt-2 lg:mt-0">Register Now</a>
    </div>
  </div>
</nav>
  </>
