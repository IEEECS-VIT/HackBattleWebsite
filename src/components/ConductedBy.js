...
export default function ConductedBy() {
  ...
  return (
    <div className="body">
      ...
      <div ref={ref3}>
        <svg className="cb-svg" width="32vw" viewBox="0 0 550 198" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path className={ inViewport2? 'cb-path' : 'cb-no-path'} d="M548.509 0.173956L548.51 117.176L1.00691 117.175L1.00684 197.738" stroke="#FF009E" strokeWidth="1.5"/>
        </svg>
      </div>
      ...
      <div ref={ref4}>
        <svg className="cb2-svg" width="1126" height="885" viewBox="0 0 1126 885" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path className={ inViewport4? 'cb2-path' : 'cb2-no-path'} stroke="#FF009E" stroke-width="1.5" d="M1115 763a5 5 0 1 0 10 0a5 5 0 1 0 -10 0" />
          <path className={ inViewport4? 'cb2-path' : 'cb2-no-path'} d="M634 1H902L1017 58H1090V347.5H1V710.5H163L311 762.5H744.5M744.5 762.5H1115M744.5 762.5V967.5" stroke="#FF009E" stroke-width="1.5" />
        </svg>
      </div>
